data:extend({
	...
	},
	{
		...
		folded_animation =
		{
			...
			{
				-- {
				--	 filename = "__mojo-exploration__/graphics/entity/tesla-turret/tesla-turret-base.png",
				--	 priority = "high",
				--	 width = 250,
				--	 height = 200,
				--	 frame_count = 10,
				...
				-- }
				{
					filename = "__mojo-exploration__/graphics/entity/tesla-turret/tesla-turret-animation.png",
					priority = "medium",
					width = 244,
					height = 204,
					frame_count = 10,
